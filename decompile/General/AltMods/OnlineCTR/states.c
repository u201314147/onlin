...
{
	DecalFont_DrawLine("RECUERDA: ESTA VERSION NO TIENE SOPORTE",0x100,0x14,FONT_SMALL,JUSTIFY_CENTER|RED);
	DecalFont_DrawLine("No reportes bugs a los desarolladores oficiales",0x100,0x1c,FONT_SMALL,JUSTIFY_CENTER|PAPU_YELLOW);
...
void StatePS1_Launch_Error()
{
	...
	sprintf(str, "SERVIDOR: %d", octr->ver_server);
	DECOMP_DecalFont_DrawLine(str,0x100,0xA8-2,FONT_SMALL,JUSTIFY_CENTER);

	char* str2 = "Actualiza las 3 para jugar";
