...
void PrintCharacterStats()
{
	...
	#if 0
	char* title = "Modo clasico de juego";
	...
	DecalFont_DrawLine("No reportes errores",posX-0x8,posY+0x8,FONT_SMALL,0);
	DecalFont_DrawLine("A los devs oficiales",posX-0x18,posY+0x10,FONT_SMALL,0);
}

char* onlineLapString = "VLTS: 0\0";
void PrintRecvTrack()
{
	char message[32];
